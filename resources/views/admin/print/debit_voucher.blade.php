...
<head>
    ...
    <title>Debit Voucher - Print</title>
</head>
<body>
...
<div class="min-h-screen p-4 sm:p-6 lg:p-8" style="background: linear-gradient(135deg, #f0f4ff 0%, #e8ecf8 100%);">
    ...
    <div class="mb-6 print:hidden flex justify-end">
        <a href="{{ route('admin.debit-voucher.index') }}"
           class="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white px-5 py-2.5 text-sm font-medium shadow-md hover:shadow-lg transition-all duration-200 w-full sm:w-auto justify-center">
            <i class="fa fa-arrow-left text-xs"></i> Back to Debit Vouchers
        </a>
    </div>

    <!-- Voucher Container -->
    <div id="voucher" class="max-w-5xl mx-auto bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl shadow-gray-200/60 border border-white/60 p-6 sm:p-8 lg:p-10">
        ...
        <div class="overflow-x-auto rounded-xl border border-gray-200/60 shadow-sm">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 bg-white/60">
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-red-50/40 hover:to-rose-50/40 transition-all duration-200">
