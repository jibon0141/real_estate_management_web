...
<head>
    ...
    <title>Credit Voucher - Print</title>
</head>
<body style="background: linear-gradient(135deg, #f0f4ff 0%, #e8ecf8 100%);">
    ...
    <div class="min-h-screen p-3 sm:p-6">
        ...
        <div class="mb-4 print:hidden flex justify-end">
            <a href="{{ route('admin.credit-voucher.index') }}"
               class="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-gray-700 to-gray-800 text-white text-sm font-medium rounded-xl shadow-md shadow-gray-300/40 hover:from-gray-800 hover:to-gray-900 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 w-full sm:w-auto justify-center">
                <i class="fa fa-arrow-left"></i> Back to Credit Vouchers
            </a>
        </div>
            ...
            <div class="overflow-x-auto rounded-xl border border-gray-200 shadow-sm">
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-emerald-50/40 hover:to-teal-50/40 transition-all duration-200">
