    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1 ml-13">Update commission type name</p>
            </div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg shadow-indigo-100/50 border border-white/50 overflow-hidden">
            <div class="p-5 border-b border-gray-100 flex items-center gap-2">
                ...
                <span class="font-semibold text-gray-700">Edit Commission Type Information</span>
            </div>
            <div class="p-6">
                <form action="{{ route('admin.commission-setting.update', $setting->id) }}" method="POST">
                    @csrf
                    @method('PUT')
