...
@section('app_styles')
<style>
    #chartOfAccountTable tbody tr:nth-child(even) { background-color: #f8fafc; }
    #chartOfAccountTable tbody tr:hover { background-color: #eef2ff; }
</style>
@endsection
@section('content')
        ...
        <div class="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h3 class="text-2xl font-bold text-gray-800 flex items-center gap-3">
                    <span class="w-10 h-10 rounded-xl bg-gradient-to-br from-pink-500 to-rose-600 flex items-center justify-center text-white shadow-lg shadow-pink-200">
                        <i class="fa fa-sitemap text-sm"></i>
                    </span>
                    Chart of Account List
                </h3>
                <p class="text-sm text-gray-500 mt-1 ml-13">Manage chart of account heads</p>
            </div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg shadow-indigo-100/50 border border-white/50 overflow-hidden">
            <div class="p-5 border-b border-gray-100 flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="font-semibold text-gray-700">All Chart of Accounts</span>
                </div>
                ...
                <table id="chartOfAccountTable" class="w-full">
                    <thead>
                        <tr class="bg-gradient-to-r from-gray-50 to-indigo-50/50">
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">GL Account</th>
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Head Type</th>
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Head Name</th>
...
<script>
    $(document).ready(function () {
        ...
        $('#chartOfAccountTable_length select').addClass('form-input !py-1.5 !px-3 !text-sm !rounded-xl !border-gray-200 !bg-gray-50 focus:!bg-white !transition-all !w-20');
        $('#chartOfAccountTable_length label').addClass('text-sm text-gray-500 flex items-center gap-2');
    });
