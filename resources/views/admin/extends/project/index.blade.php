...
@section('app_styles')
<style>
    #projectTable tbody tr:nth-child(even) { background-color: #f8fafc; }
    #projectTable tbody tr:hover { background-color: #eef2ff; }
</style>
@endsection
@section('content')
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1 ml-13">Manage projects</p>
            </div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg shadow-indigo-100/50 border border-white/50 overflow-hidden">
            <div class="p-5 border-b border-gray-100 flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="font-semibold text-gray-700">All Projects</span>
                </div>
                <span class="text-xs text-gray-400 bg-gray-50 px-3 py-1 rounded-full">DataTable</span>
            </div>
            <div class="p-5 overflow-x-auto">
                <table id="projectTable" class="w-full">
                    <thead>
                        <tr class="bg-gradient-to-r from-gray-50 to-indigo-50/50">
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Total Share</th>
    ...
    $(document).ready(function () {
        $('#projectTable').DataTable({
            ...
            columns: [
                ...
                { data: 'total_share', name: 'total_share' },
        ...
        $('#projectTable_length select').addClass('form-input !py-1.5 !px-3 !text-sm !rounded-xl !border-gray-200 !bg-gray-50 focus:!bg-white !transition-all !w-20');
        $('#projectTable_length label').addClass('text-sm text-gray-500 flex items-center gap-2');
    });
